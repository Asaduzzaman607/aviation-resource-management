...
const ApprovedManufacturer = () => {
  ...
  return (
    <CommonLayout>
      ...
      <Permission
        permission="CONFIGURATION_CONFIGURATION_MANUFACTURER_CONFIGURATION_MANUFACTURER_APPROVED_LIST_SEARCH"
        showFallback
      >
...
export default ApprovedManufacturer;
