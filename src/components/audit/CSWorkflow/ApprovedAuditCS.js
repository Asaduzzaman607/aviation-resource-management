...
const ApprovedAuditCS = () => {
  ...
  const { form, collection, page, totalElements, paginate, fetchData, size } =
    usePaginate(
      ...
      { type: 'APPROVED', rfqType: 'PROCUREMENT' }
    );
  ...
  return (
    <CommonLayout>
      ...
      <Permission
        permission="MATERIAL_MANAGEMENT_MATERIAL_MANAGEMENT_COMPARATIVE_STATEMENT_MATERIAL_MANAGEMENT_AUDIT_APPROVED_CS_SEARCH"
        showFallback
      >
        <ARMCard title="Audit Approve CS List">
          <Form
            form={form}
            onFinish={onFinish}
          >
                  ...
                  <tbody>
                    {collection?.map((data) => (
                      <tr key={data.id}>
                        ...
                        <td>
                          <Permission permission="MATERIAL_MANAGEMENT_MATERIAL_MANAGEMENT_COMPARATIVE_STATEMENT_MATERIAL_MANAGEMENT_AUDIT_APPROVED_CS_SEARCH">
                            <Link to={`/audit/approved-cs-details/${data.id}`}>
                              <ARMButton
                                type="primary"
                                size="small"
                                style={{
                        ...
                        <td>
                          <Permission permission="MATERIAL_MANAGEMENT_MATERIAL_MANAGEMENT_COMPARATIVE_STATEMENT_MATERIAL_MANAGEMENT_AUDIT_APPROVED_CS_EDIT">
                            <Link to={`/audit/approved-audit-cs-disposal/edit/${data.id}`}>
                              <ARMButton
                                type="primary"
                                size="small"
                                style={{
...
export default ApprovedAuditCS;
