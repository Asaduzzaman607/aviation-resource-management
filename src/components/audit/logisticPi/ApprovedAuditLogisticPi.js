...
const ApprovedAuditLogisticPi = () => {
  ...
  return (
    <CommonLayout>
      ...
      <Permission
        permission="AUDIT_LOGISTIC_PARTS_INVOICE_AUDIT_LOGISTIC_APPROVED_PARTS_INVOICE_AUDIT_SEARCH"
        showFallback
      >
        <ARMCard
          title={getLinkAndTitle(
            ...
            '/audit',
            false,
            'AUDIT_LOGISTIC_PARTS_INVOICE_AUDIT_LOGISTIC_APPROVED_PARTS_INVOICE_AUDIT_SAVE'
          )}
        >
          <Form
            form={form}
                  ...
                  <tbody>
                    {collection?.map((data) => (
                      <tr key={data.id}>
                        ...
                        <td>
                          <Permission permission="AUDIT_LOGISTIC_PARTS_INVOICE_AUDIT_LOGISTIC_APPROVED_PARTS_INVOICE_AUDIT_SEARCH">
                            <Link
                              to={`/audit/logistic/approved-purchase-invoice/details/${data.id}`}
                            >
                              <ARMButton
                                type="primary"
                                size="small"
...
export default ApprovedAuditLogisticPi;
