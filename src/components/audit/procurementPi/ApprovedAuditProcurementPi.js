...
const ApprovedAuditProcurementPi = () => {
  ...
  const {
    ...
    'approvedAuditProcurementInvoice',
  ...
  return (
    <CommonLayout>
      ...
      <Permission
        permission="AUDIT_MATERIAL_MANAGEMENT_PARTS_INVOICE_AUDIT_MATERIAL_MANAGEMENT_APPROVED_PARTS_INVOICE_AUDIT_SEARCH"
        showFallback
      >
        <ARMCard
          title={getLinkAndTitle(
            ...
            '/material-management',
            'blank',
            'AUDIT_MATERIAL_MANAGEMENT_PARTS_INVOICE_AUDIT_MATERIAL_MANAGEMENT_APPROVED_PARTS_INVOICE_AUDIT_SAVE'
          )}
        >
          <Form
            form={form}
                  ...
                  <tbody>
                    {collection?.map((data) => (
                      <tr key={data.id}>
                        ...
                        <td>
                          <Permission permission="AUDIT_MATERIAL_MANAGEMENT_PARTS_INVOICE_AUDIT_MATERIAL_MANAGEMENT_APPROVED_PARTS_INVOICE_AUDIT_SEARCH">
                            <Link
                              to={`/audit/procurement/approved-purchase-invoice/details/${data.id}`}
                            >
                              <ARMButton
                                type="primary"
                                size="small"
...
export default ApprovedAuditProcurementPi;
