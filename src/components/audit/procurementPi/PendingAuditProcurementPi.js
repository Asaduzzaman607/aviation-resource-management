...
const PendingAuditProcurementPi = () => {
  ...
  const {
    ...
    'pendingAuditProcurementInvoice',
    '/procurement/audit/parts-invoice/search'
  );
  ...
  const handleStatus = async (id) => {
    try {
      await PurchaseInvoiceService.toggleStatusAudit(
        id,
  ...
  const handleApprove = async (id, status, description = null) => {
    try {
      await PurchaseInvoiceService.toggleApproveAudit(
        id,
        status,
        (description = null)
      );
  ...
  return (
    <CommonLayout>
      ...
      <Permission
        permission="AUDIT_MATERIAL_MANAGEMENT_PARTS_INVOICE_AUDIT_MATERIAL_MANAGEMENT_PENDING_PARTS_INVOICE_AUDIT_SEARCH"
        showFallback
      >
        <ARMCard
          title={getLinkAndTitle(
            ...
            'blank',
            'AUDIT_MATERIAL_MANAGEMENT_PARTS_INVOICE_AUDIT_MATERIAL_MANAGEMENT_PENDING_PARTS_INVOICE_AUDIT_SAVE'
          )}
        >
          <Form
            form={form}
                  ...
                  <tbody>
                    {collection?.map((data) => (
                      <tr key={data.id}>
                        ...
                        <td>
                          <Space size="small">
                            <Permission permission="AUDIT_MATERIAL_MANAGEMENT_PARTS_INVOICE_AUDIT_MATERIAL_MANAGEMENT_PENDING_PARTS_INVOICE_AUDIT_SEARCH">
                              <Link
                                to={`/audit/procurement/pending-purchase-invoice/details/${data.id}`}
                              >
                                <ARMButton
                                  type="primary"
                                  size="small"
                            ...
                            <Permission permission="AUDIT_MATERIAL_MANAGEMENT_PARTS_INVOICE_AUDIT_MATERIAL_MANAGEMENT_PENDING_PARTS_INVOICE_AUDIT_DELETE">
...
export default PendingAuditProcurementPi;
