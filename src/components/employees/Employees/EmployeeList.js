...
const EmployeeList = () => {
  const {
    ...
    resetFilter,
    size,
  } = usePaginate('employees', '/employee/search');
        ...
        >
          ...
          >
            <Row gutter={20}>
              ...
              >
                <Form.Item name="name">
                  <Input placeholder="Search Employee No." />
                </Form.Item>
              </Col>
              <Col
                xs={24}
              ...
              <tbody>
                {collection?.map((data) => (
                  <tr key={data.id}>
                    ...
                    <td>
                      <Space size="small">
                        <Link to={`/employees/employee/details/${data.id}`}>
                          <ARMButton
                            type="primary"
                            size="small"
                            style={{
                        ...
                        <Link to={`/employees/employee/add/${data.id}`}>
                          <ARMButton
                            type="primary"
                            size="small"
                            style={{
                        ...
                        <ActiveInactiveButton
                          ...
                          handleOk={async () => {
                            try {
                              await EmployeeService.toggleStatus(
                                data.id,
                                !isActive
                              );
