    ...
    <CommonLayout>
      <ARMBreadCrumbs>
        <Breadcrumb separator="/">
          ...
          <Breadcrumb.Item>&nbsp;Logistic Purchase Orders</Breadcrumb.Item>
        </Breadcrumb>
      </ARMBreadCrumbs>
      <Permission permission="MATERIAL_MANAGEMENT_ORDER_PURCHASE_ORDER_SEARCH">
        <ARMCard
          title={getLinkAndTitle(
            'Logistic Purchase Order list',
                  ...
                  <tr key={data.id}>
                    ...
                    <td>
                      <Space size="small">
                        ...
                        <Link to={`/logistic/purchase-order/add/${data.id}`}>
                          <ARMButton
                            type="primary"
                            size="small"
                            style={{
