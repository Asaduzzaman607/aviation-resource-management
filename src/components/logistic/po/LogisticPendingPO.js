...
const LogisticPendingPO = () => {
  ...
  const {
    ...
    refreshPagination,
    size,
  } = usePaginate('pendingLogisticPO', '/logistic/part-orders/search', {
    rfqType: 'LOGISTIC',
  });

  console.log('pending procurementPi list', collection);
  ...
  const handleStatus = async (id) => {
    try {
      await LogisticPOService.toggleStatus(
        id,
  ...
  const handleApprove = async (id, status, description = null) => {
    try {
      await LogisticPOService.toggleApprove(id, status, (description = null));
      refreshPagination();
      notifySuccess('Status changed successfully!');
    } catch (e) {
    ...
    <CommonLayout>
      <ARMBreadCrumbs>
        <Breadcrumb separator="/">
          ...
          <Breadcrumb.Item>Pending Logistic Order</Breadcrumb.Item>
        </Breadcrumb>
      </ARMBreadCrumbs>
      ...
      >
        <ARMCard
          title={getLinkAndTitle(
            'Pending Logistic Order List',
            '/logistic/purchase-order/add',
            true,
            [
                      ...
                      <tr key={data.id}>
                        ...
                        <td>
                          <Space size="small">
                            ...
                            <Permission permission="LOGISTIC_LOGISTIC_ORDER_LOGISTIC_PURCHASE_ORDER_DELETE">
...
export default LogisticPendingPO;
