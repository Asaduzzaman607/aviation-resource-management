...
import CommentSection from '../../audit/LogisticCSWorkflow/CommentSection';
import {
...
const LogisticCSTableEdit = ({ generateCS, vendorLength, csNo }) => {
...
export default LogisticCSTableEdit;
