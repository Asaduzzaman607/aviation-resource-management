...
const ApprovedLogisticRFQDetails = () => {
  let { id } = useParams();
    ...
    <CommonLayout>
      <ARMBreadCrumbs>
        <Breadcrumb separator="/">
          ...
          <Breadcrumb.Item>
            <Link to="/logistic/approved-shipment-provider-rfq">
              &nbsp; Approved Logistic RFQ List
            </Link>
          </Breadcrumb.Item>
      ...
      <ARMCard
        title={getLinkAndTitle(
          `Approved Logistic RFQ details`,
          `/logistic/approved-shipment-provider-rfq`
        )}
      >
        <Row>
          <Col
...
export default ApprovedLogisticRFQDetails;
