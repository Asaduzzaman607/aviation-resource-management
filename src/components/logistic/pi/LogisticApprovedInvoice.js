    ...
    <CommonLayout>
      <ARMBreadCrumbs>
        <Breadcrumb separator="/">
          ...
          <Breadcrumb.Item>Approve Logistic Purchase Invoice</Breadcrumb.Item>
        </Breadcrumb>
      </ARMBreadCrumbs>
                      ...
                      <tr key={data.id}>
                        ...
                        <td>
                          <Permission permission="LOGISTIC_LOGISTIC_PARTS_INVOICE_LOGISTIC_PARTS_INVOICE_SEARCH">
                            <Link
                              to={`/logistic/purchase-invoice/approve-details/${data.id}`}
                            >
                              <ARMButton
                                type="primary"
                                size="small"
...
export default LogisticApprovedInvoice;
