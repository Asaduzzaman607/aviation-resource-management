  ...
  return (<Row>
    <Col sm={20} md={10}>
      ...
      >
        ...
        >
          <Select placeholder="Select a rack" disabled={isRackDisabled}
                  showSearch
                  optionFilterProp="children"
                  onSearch={onSearch}
                  onChange={(e) => {
        ...
        >
          <Select placeholder="Select a rack row" disabled={isRackRowDisabled}
                  showSearch
                  optionFilterProp="children"
                  onSearch={onSearch}
                  onChange={(e) => {
