...
const PartWiseScrapDetails = ({ partId }) => {
  const { form, collection, page, totalElements, paginate, fetchData, size } =
    usePaginate('PartDetailScrap', '/part/dashboard/scrap', {
      partId: partId,
    });
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <Link
                          to={
                            data.name === 'APPROVED'
                              ? `/store/approved-scrap-parts/view/${data.scrapId}`
                              : `/store/pending-scrap-parts/view/${data.scrapId}`
                          }
                          target="_blank"
                        >
                          <ARMButton
...
export default PartWiseScrapDetails;
