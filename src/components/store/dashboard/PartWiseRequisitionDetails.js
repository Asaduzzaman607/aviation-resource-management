...
const PartWiseRequisitionDetails = ({ partId }) => {
  const { form, collection, page, totalElements, paginate, fetchData, size } =
    usePaginate('PartDetailRequisition', '/part/dashboard/requisition', {
      partId: partId,
    });
  ...
  return (
    <>
      {/* store requisition */}
      <RibbonCard ribbonText="REQUISITION">
        <Form
          form={form}
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <Link
                          to={
                            data.name === 'APPROVED'
                              ? `/store/material-management/requisition/approved/details/${data.requisitionId}`
                              : `/store/material-management/requisition/pending/details/${data.requisitionId}`
                          }
                          target="_blank"
                        >
                          <ARMButton
...
export default PartWiseRequisitionDetails;
