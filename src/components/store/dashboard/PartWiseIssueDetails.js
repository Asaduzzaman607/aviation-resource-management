...
const PartWiseIssueDetails = ({ partId }) => {
  const { form, collection, page, totalElements, paginate, fetchData, size } =
    usePaginate('PartDetailIssue', '/part/dashboard/issue', {
      partId: partId,
    });
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <Link
                          to={
                            data.name === 'APPROVED'
                              ? `/store/approve-issues/details/${data.issueId}`
                              : `/store/pending-issues/details/${data.issueId}`
                          }
                          target="_blank"
                        >
                          <ARMButton
...
export default PartWiseIssueDetails;
