    ...
    <CommonLayout>
      <ARMBreadCrumbs>
        <Breadcrumb separator="/">
          ...
          <Breadcrumb.Item>Approve Supplier List</Breadcrumb.Item>
        </Breadcrumb>
      </ARMBreadCrumbs>

      <Permission
        permission="MATERIAL_MANAGEMENT_MATERIAL_MANAGEMENT_SUPPLIER_MATERIAL_MANAGEMENT_SUPPLIER_APPROVED_LIST_SEARCH"
        showFallback
      >
        <ARMCard
