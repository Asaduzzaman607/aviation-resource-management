...
const PendingInvoice = () => {
  ...
  const {
    ...
    'pendingInvoice',
    '/procurement/own_department/parts-invoice/search'
  );
  ...
  const handleStatus = async (id) => {
    try {
      await PurchaseInvoiceService.toggleStatus(
        id,
  ...
  const handleApprove = async (id, status, description = null) => {
    try {
      await PurchaseInvoiceService.toggleApprove(
        id,
        status,
        (description = null)
      );
                  ...
                  <tbody>
                    {collection?.map((data) => (
                      <tr key={data.id}>
                        ...
                        <td>
                          <Space size="small">
                            <Permission permission="MATERIAL_MANAGEMENT_MATERIAL_MANAGEMENT_PARTS_INVOICE_MATERIAL_MANAGEMENT_PARTS_INVOICE_SEARCH">
                              <Link
                                to={`/material-management/purchase-invoice/pending-details/${data.id}`}
                              >
                                <ARMButton
                                  type="primary"
                                  size="small"
                            ...
                            <Permission permission="MATERIAL_MANAGEMENT_MATERIAL_MANAGEMENT_PARTS_INVOICE_MATERIAL_MANAGEMENT_PARTS_INVOICE_EDIT">
                              <Link
                                to={`/material-management/purchase-invoice/${data.id}`}
                              >
                                <ARMButton
                                  type="primary"
                                  size="small"
                            ...
                            <Permission permission="MATERIAL_MANAGEMENT_MATERIAL_MANAGEMENT_PARTS_INVOICE_MATERIAL_MANAGEMENT_PARTS_INVOICE_DELETE">
