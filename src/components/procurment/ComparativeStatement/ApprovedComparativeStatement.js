...
const ApprovedComparativeStatement = () => {
  ...
  console.log('approvedCS: ', collection);
  ...
  return (
    <CommonLayout>
      ...
      <Permission permission="MATERIAL_MANAGEMENT_COMPARATIVE_STATEMENT_APPROVED_CS_SEARCH">
        <ARMCard title="Approve Manufacturers List">
          <Form
            form={form}
            onFinish={onFinish}
          >
...
export default ApprovedComparativeStatement;
