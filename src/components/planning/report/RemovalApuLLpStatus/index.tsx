...
const TITLE = "REMOVAL APU LLP STATUS";
...
export default function RemovalApuLLpStatus() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const {data} = await API.get(`/aircraft-build/apu-removed-status-report?aircraftId=${aircraftId}`)
    ...
    return <CommonLayout>
        ...
        <Permission permission="PLANNING_OTHERS_REMOVAL_APU_LLP_STATUS_SEARCH" showFallback>
            <ARMCard
                title={
