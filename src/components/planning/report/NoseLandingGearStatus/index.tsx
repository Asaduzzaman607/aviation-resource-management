...
const TITLE = " Nose Landing Gear Status";
...
export default function NoseLandingGearStatus() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const {data} = await API.get(`landing-gear-report/nlg-report?aircraftId=${aircraftId}${date ? `&date=${date}` : ''}`);
    ...
    const {onDownload} = useDownloadExcel({
        ...
        filename: 'NLG Landing Gear Report',
        sheet: 'nlgLandingGearReport'
    })
    ...
    return <CommonLayout>
        ...
        <Permission permission="PLANNING_ENGINE_PROPELLER_LANDING_GEAR_NOSE_LANDING_GEAR_STATUS_SEARCH" showFallback>
        <ARMCard
            title={
